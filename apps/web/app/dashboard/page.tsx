      ...
      <main className="shell dashboard-content" id="overview">
        ...
        <section className="dashboard-grid">
          <Panel
            id="agents"
            title="Agents"
            empty={data.agents.length === 0 ? "No agents yet." : undefined}
          >
          ...
          <Panel
            id="api-keys"
            title="API keys"
            empty={data.apiKeys.length === 0 ? "No visible API keys. Sign in to manage keys." : undefined}
          >
          ...
          <Panel
            id="runs"
            title="Run timeline"
            empty={data.runs.length === 0 ? "No runs yet." : undefined}
          >
            {data.runs.map((run) => (
              <Row
                key={run.id}
          ...
          <Panel
            id="trades"
            title="Trades"
            empty={data.trades.length === 0 ? "No trades yet." : undefined}
          >
          ...
          <Panel
            id="alerts"
            title="Notifications"
            empty={data.notifications.length === 0 ? "No notifications." : undefined}
          >
